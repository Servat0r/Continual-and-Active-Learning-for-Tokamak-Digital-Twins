...
if __name__ == '__main__':
    ...
    for index in range(1, args.ncampaigns):
        print(f"Index = {index}: ")
        for al_method in ['random_sketch_grad', 'lcmd_sketch_grad']:
            ...
            f"--al_batch_size={args.al_batch_size} --al_max_batch_size={args.al_max_batch_size} --full_first_set=1 --index={index}"
