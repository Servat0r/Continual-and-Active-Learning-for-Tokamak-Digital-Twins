...
if __name__ == '__main__':
    ...
    al_cl_strategies_interest_dictionary = get_al_cl_strategies_interest_dictionary(
        args.simulator_type, args.pow_type, args.cluster_type, args.dataset_type, args.task
    )
    if len(args.strategies) > 0:
        argument_strategies = args.strategies
    else:
    ...
    if args.mode == 'cl':
        ...
        strategies = {strategy: al_cl_strategies_interest_dictionary[strategy] for strategy in argument_strategies}
