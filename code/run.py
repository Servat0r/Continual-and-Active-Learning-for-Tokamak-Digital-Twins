...
def main():
    ...
    plot_metric_over_evaluation_experiences(
        os.path.join(log_folder, 'eval_results.csv'), 'eval_loss',
        'MSE over each experience', 'Training Experience', 'Mean Squared Error',
        show=False, start_exp=0, end_exp=4,
        savepath=os.path.join(log_folder, 'plot_of_first_5_experiences.png'),
    )
    # Plot over all experiences
    plot_metric_over_evaluation_experiences(
        os.path.join(log_folder, 'eval_results.csv'), 'eval_loss',
        'MSE over each experience', 'Training Experience', 'Mean Squared Error',
        show=False, start_exp=0, end_exp=9,
        savepath=os.path.join(log_folder, 'plot_of_all_10_experiences.png'),
    )
